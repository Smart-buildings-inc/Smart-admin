...
export const seedFloors: Floor[] = [
  ...
  },
  {
    ...
    name: "Medical Bay",
    need: "health",
    // A dedicated clinic / mini-hospital: triage, treatment beds, an isolation
    // ward, imaging and a small surgical suite — the acute-care step up from the
    // Commons clinic above the lobby.
    category: "Healthcare · Clinic & Ward",
    level: 2,
    residents: 0,
    metrics: { occupancy: 12, tempC: 22, humidityPct: 46, co2Ppm: 540, loadKw: 28 },
  },
  {
    key: "forum-academy",
    name: "Forum & Academy",
    need: "knowledge",
    // Conference + education floor: a tiered auditorium/forum for assemblies and
    // resident broadcasts, plus seminar rooms and a maker/learning lab.
    category: "Conference & Education",
    level: 3,
    residents: 0,
    metrics: { occupancy: 58, tempC: 21.8, humidityPct: 43, co2Ppm: 680, loadKw: 16 },
  },
  {
    key: "power-ops-core",
    name: "Power & Ops Core",
...
export const seedIncidents: Incident[] = [
  ...
  },
  {
    id: "seed-inc-5",
    severity: "info",
    floorKey: "medical-bay",
    title: "Medical Bay isolation ward returned to negative pressure",
    detail:
      "Post-clean cycle complete; HEPA bank back to nominal. Ward 2 re-opened for admissions.",
    createdAt: new Date(Date.now() - 1000 * 60 * 12).toISOString(),
  },
  {
    id: "seed-inc-6",
    severity: "ok",
    floorKey: "forum-academy",
    title: "Forum auditorium booked for tonight's resident assembly",
    detail: "Seats 120; AV and broadcast relay pre-flighted green.",
...
export const seedSensorPoints: SensorPoint[] = [
  ...
  // Medical Bay (health) — ward environment + acute-care load
  {
    id: "sp-medical-bay-temp",
    tag: "sensor.air.temp",
  ...
  // Forum & Academy (knowledge) — auditorium occupancy + air quality
  {
    id: "sp-forum-academy-occupancy",
