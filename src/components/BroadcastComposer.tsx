    ...
    <div className="panel panel-pad">
      ...
      <div className="mt-2 flex items-center gap-2">
        <select
          ...
          className="flex-1 rounded-lg border border-ink-600/60 bg-ink-800/60 px-2 py-1.5 text-sm text-slate-200 focus:border-signal-info focus:outline-none"
        >
        ...
        <button
          ...
          className="rounded-lg bg-signal-info px-4 py-1.5 text-sm font-semibold text-ink-950 transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
        >
